...
//TODO: display public metrics
export default function GalleryItemOverlay({ item, visible }: Props) {
	...
	return (
		<>
			<div className='cursor-default relative flex h-0 w-full items-end transition-all ease-in-out duration-150' style={{ bottom: visible ? '0px' : '-50px' }}>
